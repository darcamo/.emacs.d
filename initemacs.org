...
*** Ibuffer                                                       :Hook:Ibuffer:
    ...
    #+end_src
*** COMMENT Pomodoro                                                  :Pomodoro:
    :PROPERTIES:
    :TANGlE:   no
    :END:
    #+begin_src emacs-lisp
      ;; Employ the pomodoro technique with Emacs
      (autoload 'pomodoro "pomodoro" "Start pomodoro, also rewind pomodoro to first set." t)
      (eval-after-load "pomodoro"
        '(progn
           (add-hook 'pomodoro-message-hook
                     ;; Lambda function to call notify-send with the pomodoro message
                     (lambda (msg)
                       (djcb-popup "pomodoro" msg "/usr/share/icons/gnome/32x32/status/appointment-soon.png")))
           ))
    #+end_src
...
*** Remap Keypad keys "Home, End, etc" as the regular "Home, End, etc" keys
    ...
    #+end_src
*** COMMENT Isearch Plus                                           :IsearchPlus:
    :PROPERTIES:
    :TANGlE:   no
    :END:
    Currently if I use isearch+ then eshell won't work.
    #+begin_src emacs-lisp
      (require 'isearch+)
    #+end_src
      ...
      #+begin_src emacs-lisp
        ...
        (setq org-capture-templates
              `(
                ...
                ("tp" "Tarefa do Projeto UFC.35" entry
                 (id "UFC35Tarefas")
                 (file "~/.emacs.d/lisp/org-capture-templates/new_task.org"))
...
*** Publish                                                     :PublishOptions:
    Veja dicas em http://orgmode.org/worg/org-tutorials/org-publish-html-tutorial.html

    #+begin_src emacs-lisp
      (with-library 'org-publish
          (setq org-publish-project-alist
                '(
                  ("Org-Wiki Org Files"
                   :base-directory "~/Muse/OrgWiki/"
                   :base-extension "org"
                   :publishing-directory "~/Muse/OrgWiki/html/"
                   ;; :recursive t
                   ...
                   ;; Options for the Latex/Html exporters
                   :tags nil
                                    ;:footnotes nil

                   ;; Sitemap
                   ;; See http://orgmode.org/manual/Sitemap.html#Sitemap for more complex options
                   :auto-sitemap t
                  ...
                  ;; Figures
                  ("Org-Wiki Images"
                   :base-directory "~/Muse/OrgWiki/figs"
                   :base-extension "jpg\\|gif\\|png"
                   :publishing-directory "~/Muse/OrgWiki/html/figs"
                   ;; :recursive t
                   :publishing-function org-publish-attachment
                   )
                  ("Org-Wiki CSS" ; Peguei o css em http://blog.herraiz.org/archives/241
                   :base-directory "~/Muse/OrgWiki/css"
                   :base-extension "css"
                   :publishing-directory "~/Muse/OrgWiki/html/css"
                   ;; :recursive t
                   :publishing-function org-publish-attachment
                   )
                  ("Org-Wiki" :components ("Org-Wiki Org Files" "Org-Wiki Images" "Org-Wiki CSS") )
                  )
                )
          )
    #+end_src
...
***** Functions
      #+begin_src emacs-lisp
        ...
        (defun dar/LaTeX-insert-item-inverse-behavior ()
          ...
          (let (LaTeX-beamer-item-overlay-flag)
            (setq LaTeX-beamer-item-overlay-flag (not LaTeX-beamer-item-overlay-flag))
            (LaTeX-insert-item))
          )
      #+end_src
***** Configurations
      ...
      #+begin_src emacs-lisp
        ...
        (defvar my-mu4e-account-alist
          '(("Gmail"
             ...
             (my-default-mu4e-trash-folder "/Gmail/[Gmail].Rascunhos")
            ...
            ("Gtel"
             ...
             (my-default-mu4e-trash-folder "/Gtel/[Gmail].Rascunhos")
...
*** my-python-compile                                                     :Hook:
    ...
    #+end_src
*** COMMENT Set outline keybindings                           :Hook:Keybindings:
    :PROPERTIES:
    :TANGlE:   no
    :END:
...
*** COMMENT Elpy                                                          :Elpy:
    ...
    #+end_src
*** Elpy (manual key-bindings - Disable this if you enable elpy-mode) :Elpy:Keybindings:
    ...
    #+begin_src emacs-lisp
      ...
      (add-hook 'python-mode-hook
                (lambda ()
                  ...
                  (local-set-key "\C-\M-n" 'elpy-nav-forward-definition)
      
                  ;; M-p, C-up   elpy-backward-definition
                  (local-set-key "\C-\M-p" 'elpy-nav-backward-definition)
