...
*** Ace-Jump-Mode                                                      :AceJump:
    ...
    #+begin_src emacs-lisp
      ...
      ;; Set C-c SPC as the keybinding to start ace-jump-mode
...
*** Ace-Window                                                       :AceWindow:
    ...
    #+begin_src emacs-lisp
      ;; Set the ace-window commant to the shortcut normally used for
      ;; other-window. Notice that if there are only two windows then
      ;; other-window will be invoked.
...
* bbyac                                                                  :BBYAC:
  ...
  Activates the global bbyac mode
  #+begin_src emacs-lisp
    (bbyac-global-mode 1)
  #+end_src
...
*** Keybindings
    #+begin_src emacs-lisp
      (add-hook 'markdown-mode-hook
                (lambda ()
                  (local-set-key [f5] 'darlan/wrap-html-tag)
                  (local-set-key [C-f5] 'darlan/wrap-kbd-html-tag)
                  (local-set-key [C-f9] 'darlan/my-markdown-compile)
                  (local-set-key [M-f9] 'darlan/view-markdown-html-file)
                  ))
    #+end_src
