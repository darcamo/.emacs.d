...
(custom-set-variables
 ...
 ;; '(org-trello-files (quote ("/home/darlan/Muse/org/contas_no_trello.org")) nil (org-trello))
 '(package-selected-packages
   (quote
    (company-web xkcd org-trello hindent flycheck-haskell haskell-mode swiper emmet-mode pip-requirements company-irony-c-headers pdf-tools auto-virtualenv helm-org-rifle ace-mc csv-mode anaconda-mode esup which-key highlight-numbers jdee helm-unicode firestarter origami java-snippets helm-pages page-break-lines ob-ipython use-package web-beautify json-reformat company-edbi edbi edbi-sqlite rainbow-delimiters lorem-ipsum sqlup-mode sql-indent company-tern impatient-mode skewer-mode web-mode expand-region helm-projectile projectile emacs-eclim indent-guide avy ein helm highlight-indentation jedi magit markdown-mode multiple-cursors pyvenv helm-bibtex writegood-mode helm-company helm-gtags ggtags smart-mode-line shut-up epl git commander f dash s gscholar-bibtex base16-theme irony-eldoc flycheck-irony hydra ace-jump-mode auctex company dired-details flycheck irony company-irony image-dired+ helm-swoop yaml-mode w3m virtualenvwrapper vc-check-status unfill undo-tree ucs-utils thesaurus tabulated-list string-utils ssh-config-mode regex-tool rebox2 realgud rainbow-mode pos-tip paradox oauth2 nose nlinum naquadah-theme multi move-text math-symbol-lists makefile-runner magit-popup magit-filenotify jinja2-mode imenu+ iedit highlight-symbol hideshowvis goto-last-change gnuplot gitignore-mode gitconfig-mode git-timemachine git-gutter fringe-helper elpy ecb ebib discover-my-major dired-details+ diminish cython-mode cppcheck company-inf-python company-auctex comment-dwim-2 cmake-mode button-lock buffer-move bookmark+ bbyac badger-theme anzu anaphora ace-window ace-isearch ac-dabbrev)))
